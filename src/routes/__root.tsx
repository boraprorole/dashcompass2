...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Marsala Dashboard" },
      { name: "description", content: "Painel de controle com login, cadastro e gerenciamento de usuários." },
      { property: "og:title", content: "Marsala Dashboard" },
      { name: "twitter:title", content: "Marsala Dashboard" },
      { property: "og:description", content: "Painel de controle com login, cadastro e gerenciamento de usuários." },
      { name: "twitter:description", content: "Painel de controle com login, cadastro e gerenciamento de usuários." },
