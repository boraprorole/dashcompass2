...
function html(body: string, status = 200) {
  return new Response(
    `<!doctype html><html><head><meta charset="utf-8"><title>Google Analytics</title>
    ...
    handlers: {
      GET: async ({ request }) => {
        ...
        try {
          ...
          return html(
            `<h1>Conta conectada</h1><p>${email ?? "Google"} vinculada. Escolha a propriedade GA4 no admin.</p><a href="/admin">Voltar ao admin</a>`,
          );
        } catch (e) {
          return html(
